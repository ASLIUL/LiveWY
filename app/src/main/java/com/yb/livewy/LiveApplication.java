...
public class LiveApplication extends Application {
    ...
    private SDKOptions options() {
        ...
        config.notificationSmallIconId = R.drawable.ic_normal_header;
        // 呼吸灯配置
        ...
        options.thumbnailSize = SystemUtil.getScreenWidth(this) / 2;
    ...
    private LoginInfo loginInfo() {
        LoginInfo loginInfo = new LoginInfo(SaveUserData.getInstance(getContext()).getUserAccid(),SaveUserData.getInstance(getContext()).getUserToken());
        return loginInfo;
    }
    /**
